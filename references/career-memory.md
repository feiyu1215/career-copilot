...
- [一、设计目标](#一设计目标)
- [二、存储架构](#二存储架构)
- [三、JSONL 事件类型定义](#三jsonl-事件类型定义)
- [四、读取策略 — Summary First](#四读取策略--summary-first)
- [五、写入时机](#五写入时机)
- [六、career-profile.md 快照格式](#六career-profilemd-快照格式)
- [七、与 CatPaw 全局 memory 的关系](#七与-catpaw-全局-memory-的关系)
- [八、隐私与安全](#八隐私与安全)
- [九、脚本使用](#九脚本使用)
- [十、快照刷新策略](#十快照刷新策略)
- [十一、模块集成指南](#十一模块集成指南)
